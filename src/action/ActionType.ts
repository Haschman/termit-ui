...
export interface PendingAsyncAction {
  ...
  // allows aborting the action (needs to be explicitly implemented)
  abortController?: AbortController;
}

export interface AsyncAction extends Action, PendingAsyncAction {
  ignoreLoading?: boolean; // Allows preventing loading spinner display on async action
}
...
enum ActionType {
  ...
  LOAD_FILE_BACKUPS = "LOAD_FILE_BACKUPS",
  ...
  GET_AVAILABLE_VOCABULARIES = "GET_AVAILABLE_VOCABULARIES",

  LOAD_TERM_RELATIONSHIP_ANNOTATIONS = "LOAD_TERM_RELATIONSHIP_ANNOTATIONS",
  UPDATE_TERM_RELATIONSHIP_ANNOTATIONS = "UPDATE_TERM_RELATIONSHIP_ANNOTATIONS",
  LOAD_ANNOTATED_TERM_RELATIONSHIPS = "LOAD_ANNOTATED_TERM_RELATIONSHIPS",
}
